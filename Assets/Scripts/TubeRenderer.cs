...
public class TubeRenderer : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        g.InjectOptionalRigidbody(rb);
        g.InjectOptionalKinematicWhileSelected(false);
        g.InjectOptionalThrowWhenUnselected(true);

        gameObject.AddComponent<HandGrabInteractable>();
        HandGrabInteractable hg = gameObject.GetComponent<HandGrabInteractable>();
